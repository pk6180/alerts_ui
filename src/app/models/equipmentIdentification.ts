...
import { EquipmentPhysicalResourceId } from './equipmentPhysicalResourceId';

/**
 * The equipment identification object
 */
export interface EquipmentIdentification { 
    equipmentPhysicalResourceId?: EquipmentPhysicalResourceId;
